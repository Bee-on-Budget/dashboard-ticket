...
//   CommentScreen({required this.ticketId, required this.fileId});
...
//               stream: DataService.getFileComments(ticketId, fileId),
...
//                       DataService.addComment(ticketId, fileId,
//                           commentController.text.trim(), 'yourSenderId');
